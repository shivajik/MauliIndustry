...
export const productCategories: ProductCategory[] = [
  ...
  {
    id: "uv-quartz-lamps",
    name: "UV QUARTZ LAMPS",
    description: "",
    imageUrl: "/images/products/uv-quartz-lamps.jpg",
  },
  {
    id: "ss-test-tube-stand",
    name: "SS TEST TUBE STAND",
    description: "",
    imageUrl: "/images/products/ss-test-tube-stand.jpg",
  },
  {
    id: "uv-water-sterilizer",
    name: "ULTRAVIOLET WATER STERILIZER (UV SYSTEM)",
    description: "",
    imageUrl: "/images/products/uv-water-sterilizer.jpg",
  },
  {
    id: "ss-platform-trolley",
    name: "SS PLATFORM TROLLEY",
    description: "",
    imageUrl: "/images/products/ss-platform-trolley.jpg",
  },
  {
    id: "ss-container-trolley",
    name: "CONTAINERS WITH TROLLEY",
    description: "",
    imageUrl: "/images/products/ss-container-trolley.jpg",
  },
  {
    id: "ss-powder-spoons",
    name: "SS POWDER SPOONS",
    description: "",
    imageUrl: "/images/products/ss-powder-spoons.jpg",
  },
  {
    id: "ss-valves",
    name: "SS ZERO DEAD LEG VALVE, LOOP VALVE, DIAPHRAGM VALVE, SAMPLING VALVE, FLOW DIVERTER VALVE, BALL VALVE",
    description: "",
    imageUrl: "/images/products/ss-valves.jpg",
  },
  {
    id: "ss-sanitary-pumps",
    name: "SS SANITARY PUMPS",
    description: "",
    imageUrl: "/images/products/ss-sanitary-pumps.jpg",
  },
  {
    id: "ss-spray-balls",
    name: "SS SPRAY BALLS",
    description: "",
    imageUrl: "/images/products/ss-spray-balls.jpg",
  },
  {
    id: "ss-water-spray-gun",
    name: "SS WATER SPRAY GUN",
    description: "",
    imageUrl: "/images/products/ss-water-spray-gun.jpg",
  },
  {
    id: "pu-wheels-ss-bracket",
    name: "PU WHEELS WITH SS BRACKET",
    description: "",
    imageUrl: "/images/products/pu-wheels-ss-bracket.jpg",
  },
  {
    id: "ss-membrane-housing",
    name: "SS RO MEMBRANE HOUSING / PRESSURE TUBES",
    description: "",
    imageUrl: "/images/products/ss-membrane-housing.jpg",
  },
  {
